...
class Model:
    ...
    # convert the image into RGB and from numpy array to pytorch sensor, applying clip preprocessing
    @torch.no_grad() 
    ...
    # encoding the list of labels into feature vector
    @torch.no_grad() 
    ...
    # predict the most similar label and confidence
    @torch.no_grad()
    ...
    # displays image using predicted label
    @staticmethod
